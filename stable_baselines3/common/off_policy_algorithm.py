...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def __init__(
        ...
        supported_action_spaces: Optional[Tuple[Type[gym.spaces.Space], ...]] = None,
            ...
            for idx, done in enumerate(dones):
                if done:
                    ...
                    if log_interval is not None and self._episode_num % log_interval == 0:
                        self._dump_logs()
            self.last_rollout_reward = self.last_rollout_reward + rewards.sum()
        callback.on_rollout_end()
        self.last_rollout_reward /= num_collected_episodes
